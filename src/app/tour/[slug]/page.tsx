        ...
        <div className="lg:container relative tour-detail-section">
          <div className="py-5 mx-2 md:mx-0">
            ...
            <Breadcrum
              items={[
                ...
                { title: tour?.NameTour, isCurrentPage: true },
              ]}
            />
          </div>
          <div className="content card-new p-2 md:p-4 py-6 !bg-transparent ">
            <h2 className="text-xl md:text-2xl font-semibold uppercase mb-6 text-two">
              {tour?.NameTour}
            </h2>
          ...
          <div className="infor-section mt-10 relative leading-9 flex flex-col gap-10 md:gap-16 px-2">
            ...
            <div>
              ...
              {tour?.Schedule && <ScheduleTour schedule={tour?.Schedule} />}
            </div>
            <div>
              <Price data={tour} />
            </div>
